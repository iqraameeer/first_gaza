...
class PregWeek38DetailScreen extends StatelessWidget {
  //final int selectedWeek;
  final int selectedDay;

  PregWeek38DetailScreen({
    Key? key,
              ...
              children: [
                ...
                Expanded(
                  child: SingleChildScrollView(
                    child:
                        _buildContentForSelectedDay(selectedDay),
                  ),
                ),
              ],
            ),
